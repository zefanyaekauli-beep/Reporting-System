// frontend/web/src/modules/cleaning/pages/CleaningAttendancePage.tsx
...
export function CleaningAttendancePage() {
  ...
  const load = async () => {
    ...
    try {
      ...
      if (result.attendance && result.attendance.role_type === "CLEANING") {
  ...
  if (loading) {
    return (
      <MobileLayout title="Absensi Pembersihan">
