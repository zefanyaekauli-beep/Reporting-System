// frontend/web/src/modules/cleaning/pages/CleaningShiftCalendarPage.tsx
...
export function CleaningShiftCalendarPage() {
  ...
  async function loadShifts() {
    try {
      setLoading(true);
      setError("");
      const response = await api.get(`/cleaning/shifts/calendar?start=${rangeStart}&end=${rangeEnd}`);
  ...
  async function callShiftAction(shiftId: number, action: string) {
    try {
      ...
      await api.post(`/cleaning/shifts/${shiftId}/${action}`);
  ...
  return (
    <MobileLayout title="Kalender Shift Pembersihan">
