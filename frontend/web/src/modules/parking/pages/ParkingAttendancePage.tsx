// frontend/web/src/modules/parking/pages/ParkingAttendancePage.tsx
...
export function ParkingAttendancePage() {
  ...
  const load = async () => {
    ...
    try {
      ...
      if (result.attendance && result.attendance.role_type === "PARKING") {
  ...
  if (loading) {
    return (
      <MobileLayout title="Absensi Parkir">
