// frontend/web/src/modules/driver/pages/DriverShiftCalendarPage.tsx
...
export function DriverShiftCalendarPage() {
  ...
  async function loadShifts() {
    try {
      setLoading(true);
      setError("");
      const response = await api.get(`/driver/shifts/calendar?start=${rangeStart}&end=${rangeEnd}`);
  ...
  async function callShiftAction(shiftId: number, action: string) {
    try {
      ...
      await api.post(`/driver/shifts/${shiftId}/${action}`);
  ...
  return (
    <MobileLayout title="Kalender Shift Driver">
