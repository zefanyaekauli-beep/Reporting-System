...
import securityIcon from "../assets/icons/Icon2-26.svg";
import cleaningIcon from "../assets/icons/Icon2-26.svg";
import driverIcon from "../assets/icons/Icon2_Vehicle Patrol.svg";
import attendanceIcon from "../assets/icons/Icon2_Check In-Out.svg";
import reportsIcon from "../assets/icons/reports.svg";
import dashboardIcon from "../assets/icons/Icon2_Dashboard.svg";
import tasksIcon from "../assets/icons/custom_reports.svg";
import announcementsIcon from "../assets/icons/announcements.svg";
import shiftsIcon from "../assets/icons/Icon2_Shift Exchange.svg";
import officersIcon from "../assets/icons/Icon2_Officer List.svg";
import checklistIcon from "../assets/icons/checklist.svg";
import qrAttendanceIcon from "../assets/icons/Icon2_Massenger.svg";
import patrolIcon from "../assets/icons/Icon2_Officer List.svg";
import panicIcon from "../assets/icons/Icon2_SOS.svg";
import passdownIcon from "../assets/icons/Icon2_Shift Exchange.svg";
import darIcon from "../assets/icons/Icon2_D.A.R Reports.svg";
...
const iconMap: Record<IconKey, string> = {
  ...
  qrAttendance: qrAttendanceIcon,
  patrol: patrolIcon,
  panic: panicIcon,
  passdown: passdownIcon,
  dar: darIcon,
};

const getIcon = (name: IconKey, className?: string) => {
  const iconPath = iconMap[name];
  // return <img src={iconPath} alt={name} className={className || "w-6 h-6"} />;
  // return <img src={iconPath} alt={name} className={className || "w-12 h-12"} />;
  return <img src={iconPath} alt={name} className={"test w-full h-full"} />;
};


export const AppIcons: Record<IconKey, (props?: { className?: string }) => ReactNode> = {
  security: (props) => getIcon("security", props?.className), 
  cleaning: (props) =>  getIcon("cleaning", props?.className),
  driver: (props) =>  getIcon("driver", props?.className),
  attendance: (props) =>  getIcon("attendance", props?.className),
  qrAttendance: (props) => {
  ...
  reports: (props) =>  getIcon("reports", props?.className),
  dashboard: (props) =>  getIcon("dashboard", props?.className),
  tasks: (props) =>  getIcon("tasks", props?.className),
  announcements: (props) =>  getIcon("announcements", props?.className),
  shifts: (props) =>  getIcon("shifts", props?.className),
  officers: (props) =>  getIcon("officers", props?.className),
  patrol: (props) => {
  ...
  checklist: (props) => getIcon("checklist", props?.className),
};
