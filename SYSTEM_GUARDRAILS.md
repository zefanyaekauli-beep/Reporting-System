# System Guardrails - Complete Reference

This document extends the original system prompt with comprehensive error handling and fixing guardrails.

## Original System Prompt Sections (1-9)

[Include all sections 1-9 from the original prompt here]
...
const loadData = async () => {
  ...
  try {
    ...
    const message = err.response?.data?.detail || err.errorInfo?.detail || "Gagal memuat data";
    setErrorMsg(message);
